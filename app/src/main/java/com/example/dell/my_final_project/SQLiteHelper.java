package com.example.dell.my_final_project;
...
public class SQLiteHelper  extends SQLiteOpenHelper {
    ...
    public static final String PROFILE_TABLE="profiler";
 ...
 private static final  String CREATE_TABLE="CREATE TABLE IF NOT EXISTS "+TABLE_NAME+" ("+Table_Column_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+Table_Column_1_Name+" VARCHAR, "+Table_Column_2_Email+" VARCHAR, "+Table_Column_3_Password+" VARCHAR)";
...
//    Update data from database table
    ...
    public long insertprofile(String table2,ContentValues cv2,String whereclm2)
    {
        SQLiteDatabase dataBase = getWritableDatabase();
        long b=dataBase.insert(table2,whereclm2,cv2);
        return b;
    }
